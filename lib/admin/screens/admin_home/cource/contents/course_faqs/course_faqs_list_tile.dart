...
class CourseFAQsListTile extends StatelessWidget {
  const CourseFAQsListTile({
    Key? key,
    required this.batch,
...
class CourseFAQsListTileAdmin extends StatelessWidget {
  const CourseFAQsListTileAdmin({
    Key? key,
    required this.batch,
    required this.course,
    required this.courseFAQs,
    this.onTap,
  }) : super(key: key);
  final Batch batch;
  final Course course;
