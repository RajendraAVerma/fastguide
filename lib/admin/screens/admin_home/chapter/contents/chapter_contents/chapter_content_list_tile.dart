...
class ChapterContentListTile extends StatelessWidget {
  const ChapterContentListTile({
    Key? key,
    required this.batch,
  ...
  Widget build(BuildContext context) {
    final _contentType = chapterContent!.type;
    if (_contentType == 0) {
...
class ChapterContentListTileAdmin extends StatelessWidget {
  const ChapterContentListTileAdmin({
    Key? key,
    required this.batch,
    required this.course,
    required this.section,
  ...
  ListTile _listTileBuilder() {
    return ListTile(
      title: Text(chapterContent!.title),
