import 'package:fastguide/admin/screens/admin_home/common_widgets/date_time_picker.dart';
import 'package:fastguide/admin/screens/admin_home/common_widgets/show_exception_alert_dialog.dart';
import 'package:fastguide/admin/screens/admin_home/job_entries/format.dart';
...
class _EntryPageState extends State<EntryPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        elevation: 2.0,
        title: Text(widget.job.batchName),
        actions: <Widget>[
          FlatButton(
            child: Text(
