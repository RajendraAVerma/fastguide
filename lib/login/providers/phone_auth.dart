import 'package:fastguide/login/firebase/auth/auth.dart';
...
class PhoneAuthDataProvider with ChangeNotifier {
  ...
  void verifyOTPAndLogin({String? smsCode}) async {
    ...
    FireBase.auth.signInWithCredential(_authCredential).then(
  ...
  // _firstTimeUser(BuildContext context) async {
  ...
  //   bool firstTimerChecking = await database.checkingForFirstTimeUser(uid);
  //   if (firstTimerChecking) {
  //     return firstTimerUserForm();
  //   } else {
  //     return null;
  //   }
  // }
